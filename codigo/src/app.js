...
app.use((err, req, res, next) => {
    if (err instanceof SyntaxError) { // Se o erro for de sintaxe JSON
        return res.status(400).json({ message: 'Erro no formato do JSON. Certifique-se de que os dados estão entre aspas corretamente e números sem vírgula e sem aspas.' });
    }
